...
export default function RecipeReviewCard({
  ...
  function handleCallback() {
    const currentMusicLink = document.querySelector(
      'div.rswp__active > a > img'
    );
    if (currentMusicLink) {
  ...
  return (
    <Card className="UserInput__Music__Item__Area__Card">
      <CardHeader
        ...
        title={name}
      />
      <CardMedia component="img" height="194" image={image} alt="album" />
      {/* <CardContent>
      ...
      >
        <div
          className="Guide__Third__Item__Card__Bottom__Artist"
          style={{
            display: 'flex',
        ...
        <div className="Guide__Third__Item__Card__Bottom__Button">
          {isDisable1 ? (
            ...
            <Button onClick={musicDataInputGood} color="primary">
              <ThumbUpOffAltIcon />
            </Button>
          )}
          {isDisable2 ? (
            <Button
              onClick={musicDataInputBad}
              color="primary"
              variant="contained"
            >
              <ThumbDownOffAltIcon />
            ...
            <Button onClick={musicDataInputBad} color="primary">
              <ThumbDownOffAltIcon />
            </Button>
          )}
        </div>
